...
public class ToolCallAgent extends ReActAgent {
    ...
    public ToolCallAgent(ToolCallback[] availableTools) {
        ...
        chatOptions = DashScopeChatOptions.builder().withInternalToolExecutionEnabled(false).build();
    ...
    public boolean think() {
        if (StrUtil.isNotEmpty(getNextSepPrompt())) {
            UserMessage userMessage = new UserMessage(getNextSepPrompt());
